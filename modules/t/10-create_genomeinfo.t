...
ok( $genome->reference()    eq $args{-REFERENCE},    "reference correct" );
...
ok( $genome2->reference()    eq $args{-REFERENCE},    "reference correct" );
...
ok( $genome3->reference() eq $args{-REFERENCE}, "reference correct" );
