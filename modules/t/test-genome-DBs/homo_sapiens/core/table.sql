...
) ENGINE=MyISAM AUTO_INCREMENT=8497 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=8057105 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=50749 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=698244 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=2221 DEFAULT CHARSET=latin1;
...
CREATE TABLE `object_xref` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=16826727 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=977796 DEFAULT CHARSET=latin1;
...
CREATE TABLE `transcript` (
  ...
  KEY `analysis_idx` (`analysis_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=2263271 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=3709979 DEFAULT CHARSET=latin1;
